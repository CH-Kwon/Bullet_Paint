...
void Draw(const WEMtx44& worldMatrix);
...
/*Blends the given color with the texture*/
void SetTextureColor(unsigned char alpha, unsigned char blue,
...
void GetWorldTopLeft(WEVec2& outParam);
/*Gets the Top right corner of the world*/
void GetWorldTopRight(WEVec2& outParam);
/*Gets the Bottom left corner of the world*/
void GetWorldBotLeft(WEVec2& outParam);
/*Gets the Bottom Right corner of the world*/
void GetWorldBotRight(WEVec2& outParam);
}//end namespace WEGraphics
